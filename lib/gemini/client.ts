...
export function buildSystemInstruction(params: Partial<PromptContextParams>): string {
  ...
  const parts: string[] = [
    ...
    '',
    '### HIGH-PRIORITY DIALOGUE FORMATTING INSTRUCTIONS:',
    ...
    '3. Output pure narrative prose, character dialogue, actions, and thoughts only. Do NOT output any option lists, choice buttons, or XML tags.',
    '',
